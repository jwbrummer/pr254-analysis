// Written by Dr. P. Adsley to calibrate the ADC spectra and produce the .dat file that needs to be included in the online analyzer with the config.cfg file.
...
double gains[128], offsets[128], alpha_E[5] = {5423.15, 5685.37, 6288.08, 6778.3, 8784.86}; //alpha energies in the Thorium decay chain
