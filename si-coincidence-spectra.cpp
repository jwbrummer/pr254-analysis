//***********************************************************************************************
//	The amount of data this script works through makes it very resource intensive.
//      Close all other applications. Entire run will take about 1 hour.
//***********************************************************************************************

//Written by JWB on 16/07/2016 to generate all Si-coincidence spectra for all 24Mg from pr254.

{
  ...
  for(int i=0;i<109;i++)
      ...
      if(runs[i]<2012)
	{
	  if(runs[i]<1056)
	      ...
	      if(runs[i]==1040)
		{
	      ...
	      char histName[256];
	      sprintf(histName,"ADCCalibratedValues:X1posCorr>>hSiCoincidenceRun%d(1000,0,800,1000,0,10000)",runs[i]);
	      DATA->Draw(histName,"CUTpad1vstofRun1040 && !X1flag && !X2flag && !U1flag","col");
	      TPad *p = c1; //To draw spectra that setLogz automatically
	      p->SetLogz();
	      ...
	      if(runs[i]==1056)
		{
	      ...
	      char histName[256];
	      sprintf(histName,"ADCCalibratedValues:X1posCorr>>hSiCoincidenceRun%d(1000,0,800,1000,0,10000)",runs[i]);
	      DATA->Draw(histName,"CUTpad1vstofRun1056 && !X1flag && !X2flag && !U1flag","col");
	      TPad *p = c1; //To draw spectra that setLogz automatically
	      p->SetLogz();
	      ...
	      if(runs[i]==1076)
		{
	      ...
	      char histName[256];
	      sprintf(histName,"ADCCalibratedValues:X1posCorr>>hSiCoincidenceRun%d(1000,0,800,1000,0,10000)",runs[i]);
	      DATA->Draw(histName,"CUTpad1vstofRun1076 && !X1flag && !X2flag && !U1flag","col");
	      TPad *p = c1; //To draw spectra that setLogz automatically
	      p->SetLogz();
	  ...
	  sprintf(cBuffer,"/home/wiggert/Documents/pr254/spectra/weekend1/si-coincidence/Si-Coincidence-Run%d.C",runs[i]);
	  sprintf(pngBuffer,"/home/wiggert/Documents/pr254/spectra/weekend1/si-coincidence/Si-Coincidence-Run%d.png",runs[i]);
      ...
      else if(runs[i]>=2012 && runs[i]<3025)
	{
	  if(runs[i]<2066)
	      ...
	      if(runs[i]==2012)
		{
	      ...
	      char histName[256];
	      sprintf(histName,"ADCCalibratedValues:X1posCorr>>hSiCoincidenceRun%d(1000,0,800,1000,0,10000)",runs[i]);
	      DATA->Draw(histName,"CUTpad1vstofRun2012 && !X1flag && !X2flag && !U1flag","col");
	      TPad *p = c1; //To draw spectra that setLogz automatically
	      p->SetLogz();
	      ...
	      if(runs[i]==2066)
		{
	      ...
	      char histName[256];
	      sprintf(histName,"ADCCalibratedValues:X1posCorr>>hSiCoincidenceRun%d(1000,0,800,1000,0,10000)",runs[i]);
	      DATA->Draw(histName,"CUTpad1vstofRun2066 && !X1flag && !X2flag && !U1flag","col");
	      TPad *p = c1; //To draw spectra that setLogz automatically
	      p->SetLogz();
	  ...
	  sprintf(cBuffer,"/home/wiggert/Documents/pr254/spectra/weekend2/si-coincidence/Si-Coincidence-Run%d.C",runs[i]);
	  sprintf(pngBuffer,"/home/wiggert/Documents/pr254/spectra/weekend2/si-coincidence/Si-Coincidence-Run%d.png",runs[i]);
      ...
      else
	{
	  ...
	  char histName[256];
	  sprintf(histName,"ADCCalibratedValues:X1posCorr>>hSiCoincidenceRun%d(1000,0,800,1000,0,10000)",runs[i]);
	  DATA->Draw(histName,"CUTpad1vstofRun3025 && !X1flag && !X2flag && !U1flag","col");
	  TPad *p = c1; //To draw spectra that setLogz automatically
	  p->SetLogz();

	  char cBuffer[256];
	  char pngBuffer[256];
	  sprintf(cBuffer,"/home/wiggert/Documents/pr254/spectra/weekend3/si-coincidence/Si-Coincidence-Run%d.C",runs[i]);
	  sprintf(pngBuffer,"/home/wiggert/Documents/pr254/spectra/weekend3/si-coincidence/Si-Coincidence-Run%d.png",runs[i]);
	  c1->SaveAs(cBuffer);
	  c1->SaveAs(pngBuffer);
